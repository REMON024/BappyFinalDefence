        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeterReadingTable_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeterReadingTable_MeterTable_MeterId",
                        column: x => x.MeterId,
                        principalTable: "MeterTable",
                        principalColumn: "MeterId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeterReadingTable_CustomerId",
                table: "MeterReadingTable",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_MeterReadingTable_MeterId",
                table: "MeterReadingTable",
                column: "MeterId");
